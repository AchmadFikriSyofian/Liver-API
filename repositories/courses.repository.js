...
//   // Map result and calculate total duration, total lessons, and progress for each course
//   const mappedResult = await Promise.all(result.map(async (course) => {
...
//     const progress = lessonUpdateCount / totalLessons;

//     return {
//       id: course.id,
//       name: course.name,
//       image: course.image,
//       mentor: course.mentor.length > 0 ? course.mentor[0].mentor : null,
//       category: course.category.length > 0 ? course.category[0].category : null,
//       level: course.level,
